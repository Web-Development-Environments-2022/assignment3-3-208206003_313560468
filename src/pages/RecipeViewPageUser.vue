<template>
    ...
    <div class="container" v-else>
        ...
        <b-card-group deck style="text-align: center">
            <b-card :img-src="recipe.image" img-alt="Image" img-height="420" img-width="200" img-top tag="article"
                style="
        max-width: 65%;
        /* height: 33rem; */
        height: 15rem;
                ...
                <div class="mb-4" style="text-align: center; padding-left: 15px;">
                    <b-row>
                        ...
                        <b-avatar id="vegan" v-if="recipe.vegan" variant="transparent"
                            :src="require('@/assets/vegan.png')" size="7em" style="display:" />
        ...
        text-align: center; max-width: 35%; border-radius: 10px; padding-bottom: 20px;">
                ...
                <b-card-text style="text-align: center;">
                    <v-list-item-content> <strong id="List" v-for="r in recipe.ingredients" :key="r"
                            style="display:list-item; color: white; text-align: left; padding-bottom: 7px;"> {{ r }}
                        </strong></v-list-item-content>
...
export default {
    ...
    async created() {
        ...
        //   };
        let { instructions, ingredients, readyInMinutes, image, title, vegan, vegetarian, glutenFree, servings } = response.data;
